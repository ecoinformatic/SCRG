...
choc <- st_read("~/R/SCRG-additions/Data/choctawatchee_bay/choctawatchee_bay_lssm_POINTS_0.001deg.shp")
...
pens <- st_read("~/R/SCRG-additions/Data/santa_rosa_bay/Santa_Rosa_Bay_Living_Shoreline_POINTS_0.001deg.shp")
...
tampa <- st_read("~/R/SCRG-additions/Data/tampa_bay/Tampa_Bay_Living_Shoreline_Suitability_Model_Results_POINTS_0.001deg.shp")
...
IRL <- st_read("~/R/SCRG-additions/Data/indian_river_lagoon/UCF_livingshorelinemodels_MosquitoNorthIRL_111m.shp")
