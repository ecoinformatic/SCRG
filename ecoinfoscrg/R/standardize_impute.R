    ...
    studies[[i]] <- studies[[i]] %>%
      mutate(Response = as.numeric(case_when(
        Response %in% c("Maintain Beach or Offshore Breakwater with Beach Nourishment",
                        ...
                        "Option 2 or 5", "Option 1", "Maintain/Enhance/Restore Riparian Buffer<br>") ~ "3",
        Response %in% c("Ecological Conflicts. Seek regulatory advice.",
                        ...
                        "Maintain/Enhance/Restore Riparian Buffer<br>Ecological Conflicts. Seek regulatory advice.") ~ "2",
        Response %in% c("Groin Field with Beach Nourishment",
                        ...
                        "Option B7", "Option R3 or R4", "Option 6") ~ "1",
        TRUE ~ "1"  # NAs to 1
      )))
